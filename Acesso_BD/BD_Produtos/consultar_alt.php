...
<center><font face = "Century Gotchic" size = "6"><b>Alteração de Produtos
     Cadastrados</b><font size = "4">
...
<form name="cliente" method="POST" action="consultar_alt2.php">
    <fieldset id="a">
        ...
        <p> Id: <input name="txtid" type="text" size="20" maxlength="5" placeholder="Id do Produto" required onkeypress="return blokletras(window.event.keyCode)"></p>
    </fieldset>
    <br><br><center>
