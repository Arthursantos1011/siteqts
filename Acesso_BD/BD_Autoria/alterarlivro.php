...
<center><font face = "Century Gotchic" size = "6"><b>Alteração de Livros Cadastrados</b><font size = "4">
...
<form name="cliente" method="POST" action="alterarlivro2.php">
    <fieldset id="a">
        ...
        <p> Código: <input name="txtcod" type="text" size="20" maxlength="5" placeholder="Código do Livro" required onkeypress="return blokletras(window.event.keyCode)"></p>
    </fieldset>
    <br><br><center>
