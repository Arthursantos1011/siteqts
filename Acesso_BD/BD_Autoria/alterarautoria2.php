...
<head>
    ...
    <title>Ateração de Autoria Cadastradas</title>
    <style>
         body {
...
<center><font face = "Century Gotchic" size = "6"><b>Alteração da Autoria</b><font size = "4">
    ...
    <?php
            ...
            <form name="cliente2" method="POST" action="">
                ...
                foreach($pro_bd as $pro_mostrar)
                {
                    ...
                    <br><br><b><?php echo "Código do livro: " ;?></b>
                    <input type="text" name="txtcodliv" size="25" value='<?php echo $pro_mostrar[1]?>'>
                    <br><br><b><?php echo "Data de Laçamento: " ;?></b>   
                    <input type="text" name="txtdat" size="10" value='<?php echo $pro_mostrar[2]?>' required onkeypress="return blokletras(window.event.keyCode)"> 
